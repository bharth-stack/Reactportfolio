      ...
      <div className={classesAbout.AboutContainer}>
        ...
        <div className={`${classesAbout.aboutContent}`}>
          ...
          <p>
            ...
            dice game, Blackjack and rock paper scissors. • Basically, the
            weather app helps us to find the weather of any region or country
            and even it contains a clock. I built an Expense Tracker, Chat Box,
            and Movies List using React, Firebase API.
          </p>
          <p>
            <span>&#8658;</span> My Contributions. I contributed to PSOC-21 for
            the Bundli-frontend project, For LETSOC-21 I contributed to
            Musicophilia, I have contributed to the data structures and
            algorithms project as part of the cross winter of code program. •
            Front end mentor for Skill Spring which was organized by INDIAN
            INSTITUTE OF INFORMATION TECHNOLOGY NAGPUR (IIITN).
          </p>
          <p>
          ...
          <p>
            ...
            part of it. If accepted, Student Partners are assumed to further
            share the knowledge among the academic community.
          </p>
        </div>
        <Footer class={classesAbout.content_3a}></Footer>
      </div>
    </div>
  );
}
